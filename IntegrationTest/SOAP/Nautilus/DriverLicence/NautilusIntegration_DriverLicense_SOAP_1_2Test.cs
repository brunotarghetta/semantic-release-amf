...
{
    public class NautilusIntegration_DriverLicense_SOAP_1_2Test : NautilusIntegrationTestBase
    {
        [OneTimeSetUp]
        public void Init()
        {
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Scenario_Then_Exist()
        {
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Scenario_Then_Exist_Once()
        {
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Method_POST_Then_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Path_Then_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Query_Params_Then_Not_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Request_Body_Then_Is_Expected()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Response_Type_Then_Equal_Application_Xml_And_CharSet_Utf8()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_Nautilus_driver_license_SOAP_1_2_When_Check_Configuration_Response_Status_Code_Then_Equal_200()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public async Task Given_Nautilus_driver_license_SOAP_1_2_When_Execute_Request_Then_Response_Body_Is_Expected()
        {
            var mapping = GetMapping();
