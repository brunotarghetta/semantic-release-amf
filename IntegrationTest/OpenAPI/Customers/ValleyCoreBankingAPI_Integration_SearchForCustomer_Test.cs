...
{
    public class ValleyCoreBankingAPI_Integration_SearchForCustomer_Test : ValleyCoreBankingAPI_IntegrationTestBase
    {
        ...
        public void Init()
        {
            this.scenarioPathRegEx = new Regex("/core/v1/customers/search$", RegexOptions.IgnoreCase);
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SearchForCustomer_When_Check_Configuration_Scenario_Then_Exist()
        {
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SearchForCustomer_When_Check_Configuration_Scenario_Then_Exist_Once()
        {
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SearchForCustomer_When_Check_Configuration_Path_Then_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SearchForCustomer_When_Check_Configuration_Query_Params_Then_Not_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SearchForCustomer_When_Check_Configuration_Response_Type_Then_Equal_Application_Json()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SearchForCustomer_When_Check_Configuration_Response_Status_Code_Then_Equal_200()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public async Task Given_ValleyCoreBankingAPI_SearchForCustomer_When_Execute_Request_Then_Response_Body_Is_Expected()
        {
            var mapping = GetMapping();
            PathModel path = JsonConvert.DeserializeObject<PathModel>(mapping.Request.Path.ToString());
