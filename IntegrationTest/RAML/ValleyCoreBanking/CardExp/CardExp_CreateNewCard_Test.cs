...
namespace IntegrationTest.RAML.CardExp
{
    public class CardExp_CreateNewCard_Test : ValleyCoreBankingRAML_IntegrationTestBase
    {
        [OneTimeSetUp]
        public void Init()
        {
            this.scenarioPath = "/core/raml/v1/card/";
            this.scenarioTitle = "";
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Scenario_Then_Exist()
        {
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Scenario_Then_Exist_Once()
        {
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Path_Then_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Request_Method_Then_Is_POST()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Query_Params_Then_Not_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Headers_Then_There_Is_Not_Diffeence()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Request_Body_Then_Is_Expected()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Response_Type_Then_Equal_Application_Json()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Response_Status_Code_Then_Equal_201()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_CardExp_CreateNewCard_When_Check_Configuration_Response_Body_Then_Is_Expected()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public async Task Given_CardExp_CreateNewCard_When_Execute_Request_Then_Response_Body_Is_Expected()
        {
            var mapping = GetMapping();
