...
namespace IntegrationTest.OpenAPI.Ach
{
    public class ValleyCoreBankingAPI_Integration_SetAchFilefransfer_Test : ValleyCoreBankingAPI_IntegrationTestBase
    {
        [OneTimeSetUp]
        public void Init()
        {
            this.scenarioPath = "/core/v1/ach/filetransfer";
            this.scenarioTitle = "";
            ...
            const string configuredResponseBody = "{\"status\": \"Success\",  \"transactionId\": \"O123456789\"}";
            responseBody = JObject.Parse(configuredResponseBody);
        }

        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Scenario_Then_Exist()
        {
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Scenario_Then_Exist_Once()
        {
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Path_Then_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Request_Method_Then_Is_POST()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Query_Params_Then_Not_Exist()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Request_Body_Then_Is_Expected()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Headers_Then_There_Is_Not_Diffeence()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Response_Type_Then_Equal_Application_Json()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Response_Status_Code_Then_Equal_200()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public void Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Check_Configuration_Response_Body_Then_Is_Expected()
        {
            var mapping = GetMapping();
        ...
        [Test]
        public async Task Given_ValleyCoreBankingAPI_SetAchFilefransfer_When_Execute_Request_Then_Response_Body_Is_Expected()
        {
            var mapping = GetMapping();
